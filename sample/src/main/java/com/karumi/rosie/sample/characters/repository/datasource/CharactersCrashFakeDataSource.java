...
public class CharactersCrashFakeDataSource extends EmptyPaginatedReadableDataSource<String, CharacterCrash> {

  private static final long SLEEP_TIME_IN_MILLISECONDS = 4000;
  ...
  private CharacterCrash[] characters;

  @Inject public CharactersCrashFakeDataSource() {
    initCharacterCrashs();
  }

  @Override public CharacterCrash getByKey(String key) throws Exception {
    CharacterCrash character;
    fakeDelay();
  ...
  @Override public PaginatedCollection<CharacterCrash> getPage(Page page)
      throws MarvelApiException {
    int offset = page.getOffset();
    int limit = page.getLimit();

    Collection<CharacterCrash> charactersToReturn = new LinkedList<>();
    fakeDelay();
    ...
    PaginatedCollection<CharacterCrash> charactersPage = new PaginatedCollection<>(charactersToReturn);
    charactersPage.setPage(page);
    charactersPage.setHasMore(offset + charactersToReturn.size() < characters.length);
    return charactersPage;
  }

  private void initCharacterCrashs() {
    characters =
        new CharacterCrash[] {getSpiderman(),
            getCaptainMarvel(),
            getHulk(),
            getThor(),
            getIronMan(),
  ...
  @NonNull private CharacterCrash getSpiderman() {
    CharacterCrash spiderman = new CharacterCrash();
  ...
  @NonNull private CharacterCrash getCaptainMarvel() {
    CharacterCrash captainMarvel = new CharacterCrash();
  ...
  @NonNull private CharacterCrash getHulk() {
    CharacterCrash hulk = new CharacterCrash();
  ...
  @NonNull private CharacterCrash getThor() {
    CharacterCrash hulk = new CharacterCrash();
  ...
  @NonNull private CharacterCrash getScarletWitch() {
    CharacterCrash scarlet = new CharacterCrash();
  ...
  @NonNull private CharacterCrash getWolverine() {
    CharacterCrash wolverine = new CharacterCrash();
  ...
  @NonNull private CharacterCrash getStorm() {
    CharacterCrash storm = new CharacterCrash();
  ...
  @NonNull private CharacterCrash getIronMan() {
    CharacterCrash hulk = new CharacterCrash();
