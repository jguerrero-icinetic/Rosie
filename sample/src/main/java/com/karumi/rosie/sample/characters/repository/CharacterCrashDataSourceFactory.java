...
import com.karumi.rosie.sample.characters.repository.datasource.CharactersCrashFakeDataSource;
import com.karumi.rosie.sample.characters.repository.datasource.CharactersFakeDataSource;

import javax.inject.Inject;

class CharacterCrashDataSourceFactory {

  @Inject public CharacterCrashDataSourceFactory() {
  }

  PaginatedReadableDataSource<String, CharacterCrash> createDataSource() {
    return new CharactersCrashFakeDataSource();
  }
}
